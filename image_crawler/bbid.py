"""
Author: Sun Suibin 
Date: 2018-11-26 20:39:44 
Last Modified by:   Sun Suibin 
Last Modified time: 2018-11-26 20:39:44 
"""
...
def fetch_images_from_keyword(pool_sema: threading.Semaphore, keyword: str, output_dir: str, filters: str, limit: int):
    ...
    while True:
        request_url = 'https://www.bing.com/images/async?q=' + \
            urllib.parse.quote_plus(keyword) + '&first=' + str(current) + '&count=35&adlt=' + adlt + '&qft=' + ('' if filters is None else filters)
